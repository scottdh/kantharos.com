...
$sections[] = array(
	...
	'fields' => array(
		...
		array(
			'id' => 'general_use_horizontal_menu',
			'title' => __("Use horizontal type menu?", 'ct_theme'),
			'type' => 'select_show',
			'std' => 0
		),
	)
...
$sections[] = array(
	...
	'group' => __("General", 'ct_theme'),
	'title' => __('Widgets', 'ct_theme'),
	'desc' => __('Widgets settings', 'ct_theme'),
	'fields' => array(
		array(
			'id' => 'info',
			'type' => 'info',
			'desc' => __('<h4>Top social icons</h4>', 'ct_theme')
		),
		array(
			'id' => 'general_twit_user',
			'type' => 'text',
		...
		array(
			...
			'title' => __("Show top seach icon?", 'ct_theme'),
			'type' => 'select_show',
			'std' => 0
		),
	)
