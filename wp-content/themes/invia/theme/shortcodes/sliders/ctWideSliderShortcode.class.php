...
class ctWideSliderShortcode extends ctShortcode {
	...
	public function handle($atts, $content = null) {
		...
		$tabs = '<div class="flexslider mainslider loading-slider"><ul class="slides">';
		...
		return $tabs . '<div'.$this->buildContainerAttributes(array('class'=>array('bgnavmainslider')),$atts).'>
								            <div class="container">
	...
	public function getAttributes() {
		return array(
			...
			'loop' => array('label' => __('loop slider?', 'ct_theme'), 'default' => 'false', 'type' => 'select', 'choices' => array("true" => __("true", "ct_theme"), "false" => __("false", "ct_theme"))),
		);
	}
